...
async function smokeTest() {
    ...
    try {
        const response = await analysisAgent.generate('A 45-year-old male presents with fever, cough, and shortness of breath for 3 days. Temperature 38.5°C, HR 110, RR 22, SpO2 92% on room air. What is your differential diagnosis?');
