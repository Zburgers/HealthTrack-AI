...
export default function LoginPage() {
  ...
  if (isLoaded && isSignedIn) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-sky-900">
        ...
        >
          <motion.div animate={{ rotateY: [0, 360, 0] }} transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }} className="inline-block">
            <Activity className="h-16 w-16 text-sky-400 mx-auto" />
          </motion.div>
          <p className="text-xl font-semibold text-sky-300">Redirecting to dashboard...</p>
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-sky-900 text-white flex flex-col items-center justify-center p-4 overflow-hidden">
      ...
      >
        <Link href="/">
          <Button variant="ghost" size="sm" className="text-slate-300 hover:text-white hover:bg-slate-700/50 transition-all duration-300 group">
      ...
      >
        <Link href="/">
          <Button variant="outline" size="icon" className="bg-slate-800/60 border-slate-600 text-slate-300 hover:text-white hover:bg-slate-700/80 hover:border-sky-500/50 transition-all duration-300 group backdrop-blur-sm">
        ...
        >
          <Card className="w-full max-w-md bg-slate-800/60 backdrop-blur-md border-slate-700/70 shadow-2xl rounded-2xl overflow-hidden">
            <CardHeader className="text-center pt-8 pb-6">
              <motion.div className="inline-block mb-4" initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 260, damping: 20, delay: 0.6 }}>
