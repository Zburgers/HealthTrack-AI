...
async function initializeSwitchboard() {
    ...
    try {
        ...
        const memoryDataSource = new MongoDBMemoryDataSource_1.MongoDBMemoryDataSource();
        ...
        const atlasDataSource = new MongoDBAtlasDataSource_1.MongoDBAtlasDataSource();
 ...
 */
async function autoInitializeCaseEmbeddings(dataSourceManager) {
