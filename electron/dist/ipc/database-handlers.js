...
const sqlite_db_1 = require("../db/sqlite-db"); // Corrected import
/**
...
function setupDatabaseIpcHandlers() {
    ...
    electron_1.ipcMain.handle('sqlite-operation', async (event, { operation, collection, payload }) => {
...
class SQLiteAdapter {
    ...
    buildWhereClause(filter) {
        ...
        for (const key in filter) {
            ...
            if (key === '$or') {
                const orConditions = value.map((orFilter) => {
