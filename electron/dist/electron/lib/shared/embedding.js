...
exports.getEmbeddingsVertexAI = getEmbeddingsVertexAI;
...
const hfClient = new inference_1.InferenceClient(HF_KEY);
...
const VertexAIEmbeddingResponseSchema = zod_1.z.object({
    predictions: zod_1.z.array(zod_1.z.array(zod_1.z.array(zod_1.z.number()))),
    deployedModelId: zod_1.z.string().optional(),
    model: zod_1.z.string().optional(),
    modelDisplayName: zod_1.z.string().optional(),
...
async function getEmbeddingsVertexAI(texts) {
