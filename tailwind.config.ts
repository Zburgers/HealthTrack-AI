...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: {
        lg: "var(--radius)",
        md: "calc(var(--radius) - 2px)", // Adjusted to maintain relative sizing
        sm: "calc(var(--radius) - 4px)", // Adjusted to maintain relative sizing
      },
      fontFamily: {
        body: ["Manrope", "sans-serif"], // Changed to Manrope
